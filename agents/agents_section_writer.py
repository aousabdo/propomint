...
_SECTION_WRITING_INSTRUCTIONS = [
    ...
    "Refer to RFP sources in natural language—cite the page or requirement inside the sentence (e.g., \"per the RFP on page 3\") instead of bracketed tags like [COMP-1].",
